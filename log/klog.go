...
func (l *klogWrapper) WithDepth(depth int) logr.Logger {
	return logr.New(&klogWrapper{
		level:    l.level,
		current:  l.current,
		prefixes: l.prefixes,
...
func (l *klogWrapper) Init(info logr.RuntimeInfo) {
...
func (l *klogWrapper) Info(level int, msg string, keysAndValues ...interface{}) {
...
// some info logs.
func (l *klogWrapper) Enabled(level int) bool {
	return true
}
...
func (l *klogWrapper) Error(err error, msg string, keysAndValues ...interface{}) {
...
func (l *klogWrapper) V(level int) logr.Logger {
	if level < l.level {
...
func (l *klogWrapper) WithValues(keysAndValues ...interface{}) logr.LogSink {
	prefixes := []string{}
	prefixes = append(prefixes, l.prefixes...)
...
func (l *klogWrapper) WithName(name string) logr.LogSink {
	if name == "" {
		return &klogWrapper{
			level:    l.level,
			current:  l.current,
...
func (l *klogWrapper) formatMsg(msg string, keysAndValues ...interface{}) string {
