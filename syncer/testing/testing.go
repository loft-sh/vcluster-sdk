...
type SyncTest struct {
	...
	Sync    func(ctx context.Context, pClient *FakeIndexClient, vClient *FakeIndexClient, scheme *runtime.Scheme, log log.Logger)
	Compare Compare
}
...
func (s *SyncTest) Run(t *testing.T) {
	...
	// do the sync
	s.Sync(ctx, pClient, vClient, scheme, log.New(s.Name))
