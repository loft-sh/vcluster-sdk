...
type FakeSyncer struct {
	ForwardCreateFn       func(ctx context.Context, vObj client.Object, log log.Logger) (ctrl.Result, error)
	ForwardUpdateFn       func(ctx context.Context, pObj client.Object, vObj client.Object, log log.Logger) (ctrl.Result, error)
	ForwardUpdateNeededFn func(pObj runtime.Object, vObj client.Object) (bool, error)

	BackwardUpdateFn       func(ctx context.Context, pObj client.Object, vObj client.Object, log log.Logger) (ctrl.Result, error)
...
func (f *FakeSyncer) ForwardCreate(ctx context.Context, vObj client.Object, log log.Logger) (ctrl.Result, error) {
...
func (f *FakeSyncer) ForwardUpdate(ctx context.Context, pObj client.Object, vObj client.Object, log log.Logger) (ctrl.Result, error) {
...
func (f *FakeSyncer) BackwardUpdate(ctx context.Context, pObj client.Object, vObj client.Object, log log.Logger) (ctrl.Result, error) {
